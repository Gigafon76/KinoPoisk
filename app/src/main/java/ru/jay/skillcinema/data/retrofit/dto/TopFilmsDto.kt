...
import ru.jay.skillcinema.data.entity.retrofit.Country
import ru.jay.skillcinema.data.entity.retrofit.Genre
import ru.jay.skillcinema.data.entity.retrofit.TopFilms
...
data class TopFilmsDto(
    ...
    @Json(name = "films")
    override val films: List<ru.jay.skillcinema.data.retrofit.dto.TopFilmsList>?
) : TopFilms

@JsonClass(generateAdapter = true)
data class TopFilmsList(
    @Json(name = "countries")
    override val countries: List<ru.jay.skillcinema.data.retrofit.dto.Country>,
    @Json(name = "filmLength")
    override val filmLength: String?,
    @Json(name = "genres")
    override val genres: List<ru.jay.skillcinema.data.retrofit.dto.Genre>,
    @Json(name = "filmId")
